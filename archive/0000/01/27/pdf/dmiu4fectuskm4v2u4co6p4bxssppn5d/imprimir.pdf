        ...
        function insertParam(key, value) {
            ...
            <div class="cap_head clearfix">
                ...
                <div class="cap_side pull-right">
                    <h4 id="text">www.historiadodia.pt</h4>
            ...
            <p class="cap_mess cap_text text-center">
                We have noticed an unusual activity from your <b>IP 194.210.235.5</b> and blocked access to this website.
            </p>
        ...
        window.check = function (value) {
            $.ajax({
                ...
                if (data['success']) {
                    ...
                    $("#text").text(
                        "IP 194.210.235.5 has been unblocked"
                    );
                    setTimeout(do_reload, 1000);
                } else {
                    grecaptcha.reset();
